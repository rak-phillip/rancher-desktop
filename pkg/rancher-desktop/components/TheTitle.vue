  ...
  watch: {
    ...
    action: {
      handler(current) {
        ...
        if (componentCache[current]) {
          this.dynamicComponent = componentCache[current];
        } else {
          import(`@pkg/components/${ current }.vue`).then((component) => {
            componentCache[current] = component.default;
            this.dynamicComponent = componentCache[current];
          });
        }
      },
